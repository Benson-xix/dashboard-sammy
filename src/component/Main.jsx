...
const Main = () => {
  ...
  return (
    <div>
        ...
        <div className='moveleft' style={{position:"relative", width:"398px", height:"247px", margin:"1em" }}>

             <div className='topmoveleft' style={{ position:"absolute",   width:"354px" , height:"186px", top:"71px", left:"22px", borderRadius:"20.16px", backgroundColor:"#C78A8F", display:"flex", flexDirection:"row"}}>
            ...
            <div className='ontopmoveleft' style={{ position:"absolute", width:"398px", height:"209.44px", top:"10px", background:"#7758D4", borderRadius:"22.66px", display:"flex", flexDirection:"column" }}>
            ...
            <div className='axterik' style ={{marginTop:".3em", marginLeft:"2.3em"}}> *** *** ***</div>

            <div className='zahr' style={{display:"flex", flexDirection:"row", marginTop:"4em", marginLeft:"2.7em", gap:"40px"}}>
                <div style={{display:"flex", flexDirection:"column"}} >
                    <div className="life1" style={{ width:"30px", height:"30px",background:"rgba(255, 255, 255, 0.37)", marginLeft:"2em", borderRadius:"3.96px",  padding:".4em", transform: " matrix(1, 0, 0, -1, 0, 0)"}}> 
                ...
                <div style={{display:"flex", flexDirection:"column"}}>
                    <div className="life1" style={{ width:"30px", height:"30px",background:"rgba(255, 255, 255, 0.37)", marginLeft:"1em", borderRadius:"3.96px",  padding:".4em", transform: " matrix(1, 0, 0, -1, 0, 0)"}}>
                ...
                <div style={{display:"flex", flexDirection:"column"}}>
                    <div className="life1" style={{ width:"30px", height:"30px",background:"rgba(255, 255, 255, 0.37)", marginLeft:"1.5em", borderRadius:"3.96px", padding:".4em", transform: " matrix(1, 0, 0, -1, 0, 0)"}}>
        ...
        <div className='income'>
            ...
            <div >
                <div className='almighty' style={{display:"flex", flexDirection:"row", marginLeft:"1em", marginTop:"1em", gap:"1em"}}>
                    ...
                    <div className='disapper' style={{marginTop:".5em",display:"flex", flexDirection:"row", gap:"1em"}}>
                    ...
                    <div>
                        <div className='why-far'  style={{display:"flex", flexDirection:"row",  marginLeft:"4em", gap:".5em", padding:".4em", borderRadius:"11.8746px", width:"65.42px", height:"26.42px", border:"0.670819px solid #E5E9F4" }} >
        ...
        <div className='down'>
            ...
            <div >
                <div className='takeout' style={{display:"flex", flexDirection:"row", marginLeft:"1em", marginTop:"1em", gap:"1em"}}>
                    <div className='out-out' style={{width:"13.42px", height:"13.42px", background:"#7468E4", padding:".8em", borderRadius:"100%", position:"relative" }}>
        ...
        <div className='second'>
            <div style={{display:"flex", flexDirection:"column"}}>
                <div className='hide-boss' style={{display:"flex", flexDirection:"column", width:"398px", height:"138px",  marginTop:".8em", marginLeft:"1em", border:" 2px solid rgba(118, 118, 118, 0.05)", borderRadius:" 10px",}}>
                    <h3 className='text'>Available Balance</h3>
                    <p className='p'>$40,000,000</p>
                </div>
                <div className="row-boss">
                <div className='boss-row' style={{display:"flex", flexDirection:"column", width:"390px", order:"1", height:"217px",  paddingTop:"1.5em", marginTop:".8em", marginLeft:"1em", border:" 2px solid rgba(118, 118, 118, 0.05)", borderRadius:" 10px",}}>
        ...
        <ProgressBar key={idx} bgcolor={item.bgcolor} completed={item.completed}/>))}
                ...
                <div className='deal-time' style={{display:"flex", flexDirection:"column", width:"390px", order:"2", height:"302px", marginTop:".8em", marginLeft:"1em", border:" 2px solid rgba(118, 118, 118, 0.05)", borderRadius:" 10px",}}>
                  <div className='deal'>  
                    <h4 >Recent activity</h4>
                    <p >view statement</p>
                    <p className='hid'>view More</p>
                    <img src={papper} alt="" />
                    </div>
                    <TimeLine/>
                </div>
            ...
            <div style={{display:"flex", flexDirection:"column"}}>
            <div className='idan' style={{display:"flex", flexDirection:"column", width:"748px",  height:"415px",  marginTop:".8em", marginLeft:"1em", border:" 2px solid rgba(118, 118, 118, 0.05)", borderRadius:" 10px",}}>
            ...
            <div className='idan2' style={{display:"flex", flexDirection:"column",  width:"743px", order:"1", height:"257px", marginTop:".8em", marginLeft:"1em", border:" 2px solid rgba(118, 118, 118, 0.05)", borderRadius:" 10px",}}>
